...
class ProductController extends BaseController
{
    ...
    public function create()
    {
        ...
        return View::make("admin.products.create", ['units' => $units, 'categories' => $categories]);
    }
    ...
    public function edit(Product $product)
    {
        ...
        return View::make("admin.products.edit", ['units' => $units, 'categories' => $categories, 'product' => $product]);
    }
