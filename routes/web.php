...
Route::middleware('frontend:web')->group(function () {
    Route::prefix('{lang?}')->attribute('namespace', 'Web')->group(function () {
        Route::get('/', ['uses' => 'HomeController@index', 'as' => 'web.home.index']);
        Route::get('/contact-us', ['uses' => 'TicketsController@contactUs', 'as' => 'web.tickets.contact_us']);
        Route::post('/contact-us-message', ['uses' => 'TicketsController@store', 'as' => 'web.tickets.contact_us_message']);
        ...
        Route::get('/category/{category}/products', ['uses' => 'ProductController@index', 'as' => 'web.category.products']);
        Route::get('/product/{product}', ['uses' => 'ProductController@show', 'as' => 'web.product.show']);
        Route::get('order/{order}/success', ['uses' => 'OrderController@success', 'as' => 'web.order.success']);
        Route::resource('orders', 'OrderController', ['as' => 'web']);
        Route::get('add-to-cart/{product}', ['uses' => 'CartController@addToCart', 'as' => 'web.add.to.cart']);
        Route::patch('update-cart', ['uses' => 'CartController@updateCart', 'as' => 'web.update.cart']);
        Route::delete('remove-from-cart', ['uses' => 'CartController@removeFromCart', 'as' => 'web.remove.from.cart']);
        Route::get('cart', ['uses' => 'CartController@index', 'as' => 'web.cart.index']);
    });

    Route::prefix('{lang?}')->attribute('namespace', 'Web')->middleware('auth:web')->group(function () {

        Route::get('/user/dashboard', ['uses' => 'UserController@dashboard', 'as' => 'user.dashboard']);
        ...
        Route::get('/user/wishlist', ['uses' => 'UserController@wishList', 'as' => 'web.user.wishlist']);
        Route::get('/user/orders', ['uses' => 'UserController@orders', 'as' => 'web.user.orders']);
...
Route::prefix('{lang?}/admin')->attribute('namespace', 'Admin')->middleware('admin:web')->group(function () {
    ...
    Route::resource('features', 'FeatureController', ['as' => 'admin'])->only([
        "index", "edit", "update"
    ]);
