                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.categories.update', ['category' => $item]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <label class="custom-switch">
                                            <input type="checkbox" name="show_home" value="1" {{ $item->show_home ? 'checked' : '' }} class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description">{{trans('show')}} {{trans('home')}}</span>
                                        </label>
                                    </div>
                                    <div class="form-group col-md-3">
